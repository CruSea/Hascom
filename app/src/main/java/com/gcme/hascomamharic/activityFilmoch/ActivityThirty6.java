 ...
 */
public class ActivityThirty6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filmoch36);
        ...
        web2.loadUrl(getResources().getString(R.string.movie_title_two_link));
