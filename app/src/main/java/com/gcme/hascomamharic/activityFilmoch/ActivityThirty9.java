 ...
 */
public class ActivityThirty9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filmoch39);
        ...
        web5.loadUrl(getResources().getString(R.string.movie_title_five_link));
