 ...
 */
public class ActivityThirty8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filmoch38);
        ...
        web4.loadUrl(getResources().getString(R.string.movie_title_four_link));
